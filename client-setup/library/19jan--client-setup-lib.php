...
//                                . "OR (user_id = 1 AND meta_key='logged_in_amount') OR (user_id = 1 AND meta_key='average_time')";
           ...
           if($key == ST_KEY){
                ...
                if(!empty($setup)){
                    ...
                    if($_SERVER['SERVER_ADDR'] == '172.31.32.200' || $_SERVER['SERVER_ADDR'] == '172.31.14.184' || $_SERVER['SERVER_ADDR'] == '172.31.13.53'){
            ...
            $wpdb->query
                    ...
                    $wpdb->prepare
                            (
                            "UPDATE " . client_crons . " SET status = %d WHERE agency_id = %d",
                            $status, $setup_id
                    )
            );
            // Code Ends by Rudra
