...
<div class="contaninerinner">         
    ...
    <div class="panel panel-primary">        
        ...
        <div class="panel-body">
            ...
            <div class="purchased_addons">
                <div class="pur_addons_row head">
                    <div class="pur_addons_td">Add Ons</div>
                    <div class="pur_addons_td">Purchase Date</div>
                    <div class="pur_addons_td">Amount</div>
                    <div class="pur_addons_td">Payment Status</div>
                    <div class="pur_addons_td">Action</div>
                    <div class="pur_addons_td">Less From Subscription</div>
                </div>
                <?php
                ...
                foreach($paid_addons as $paid_addon){
                    ...
                    ?>
                    <div class="pur_addons_row">
                        <div class="pur_addons_td"><strong><?php echo $addons_type;?></strong></div>
                        <div class="pur_addons_td"><?php echo $addons_date;?></div>
                        <div class="pur_addons_td">$<?php echo round($addons_amount,2);?></div>
                        <div class="pur_addons_td"><?php echo $addons_status;?></div>
                        <div class="pur_addons_td">
                        ...
                        <div class="pur_addons_td">$<?php echo $minus_amount;?></div>
                    </div>
                    <?php
                }
                ?>
