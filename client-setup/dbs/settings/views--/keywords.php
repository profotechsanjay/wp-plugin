...
if (isset($_POST["submit_keywrds"])) {
    ...
    if((($total_keyword_limit >= $count_all_locations_kw) && ($comp_total_keyword_limit >= $count_all_locations_ckw) && ($billing_enable == '1')) || ($billing_enable == '0')){
        ...
        if ($ReportID > 0) {
            ...
            include_once ABSPATH. '/wp-content/themes/twentytwelve/analytics/BrightLocalUtils.php';
            ...
            if ($_SERVER['HTTP_HOST'] != 'localhost' && ($_SERVER['HTTP_HOST'] != '127.0.0.1')) {
                ...
                //=======================================
                update_user_meta($UserID, 'rank_check_options', $_POST['rank_check_options']);
                $Content_keyword_Site2 = get_user_meta($UserID, "Content_keyword_Site",TRUE);
                ...
                if ($_POST['rank_check_options'] == 'check_only_landing_pages') {                
    ...
    }elseif($total_keyword_limit < $count_all_locations_kw){
        echo '<div class="keyword_alert">Keyword is not saved, Because your Limit to add keyword is over, So please contact to Administrator or Purchase <strong>Keyword Add-Ons</strong> for increase Limit.</div>';
    }elseif($comp_total_keyword_limit < $count_all_locations_ckw){
        echo '<div class="keyword_alert">Keyword is not saved, Because your Limit for <strong>Comp keyword</strong> is over, So please contact to Administrator or Purchase <strong>Comp Keyword Add-Ons</strong> for increase Limit.</div>';
    }
            ...
            <div id="content" role="main">
                ...
                <div class="en-right">
                    ...
                    if ($success_msg != '') {
                        ...
                        echo '<div style="color:green;margin-left:20px;font-weight: bold;font-size:17px;">' . $success_msg . '</div><div class="clear_both"></div>';
                    }
                    ...
                    <form name="keyword" method="post" action="">   
                        <div style="float:right;width:500px;">
                            ...
                            <b style="float:right;">Rank Setting: </b>
                            <script>
                        ...
                        <div style="margin-top: 5px; float:left;width:100%;">
                            <div class="margin-bottom-10">
                                ...
                                <div style="float:right;width:50%;">
                                    ...
                                    <div class="rankreport"style="width: unset;float:right;"><a href="<?php echo site_url(); ?>/wp-content/plugins/settings/views/csv_keyword_list.php?csv_type=keyword_list&mccuserid=<?php echo $UserID; ?>" ><input  type="button"  value="Download Keyword"></a></div>
