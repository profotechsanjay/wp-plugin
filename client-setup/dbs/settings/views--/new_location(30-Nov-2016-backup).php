...
if($count_locations >= $allow_min_free_locations && $current_loc_status == 0){
                ...
                <tr>
					...
					<td><div id="others_acc">' . $others_account_value . '</div>
                                ...
                                <tr>
                                    ...
                                    <td><input type="checkbox" '.$checked.' class="term_cond" name="term_cond" required><br>1) Minimun 5 Locations free under minimum Package. <br>
                                    2) After 5 locations, charge $100 per location and per month.<br>
...
function paid_locations(form) {
    if(jQuery("#form_url").valid()){
        if(jQuery('.term_cond').is(':checked')){
            //alert("hello");        
            var message = "This Location is paid. Payment will automatically added to your subscription, which will detect on next payment cycle. Are you sure to Proceed?";
