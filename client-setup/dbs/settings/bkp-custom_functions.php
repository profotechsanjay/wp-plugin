...
function billing_info($MCCUserId) {
    ...
    if(!empty($location_bill)){
        ...
        if($total_keyword_oppo == '' || empty($total_keyword_oppo)){
        ...
        if($total_citation_tracker == '' || empty($total_citation_tracker)){
        ...
        if($total_site_audit == '' || empty($total_site_audit)){
