...
if(isset($_POST['saveconfigfile'])){
    //pr($_POST); die;
    $keys_excluded = array('saveconfigfile','mainheadval');
    $data = $_POST;
    $str = "<?php \n\n"; $m = 0; $n = 0;
...
<div class="contaninerinner setuppageinner">
    ...
    <?php $content = file_get_contents($global_config);
                ...
                <div id="cronview" class="tab-pane fade <?php echo isset($_GET['view']) || $_GET['view'] == 'cron'?'in active':''; ?>">
                    ...
                    <div class="cronlist">
                        ...
                        <?php 
                            ...
                            $data = str_replace("{{analytic_url}}", PROTOCOL.$setup->analytic_url, $data);                            
