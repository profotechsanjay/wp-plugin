...
if($ulog_role == 'administrator' || isagencylocation()){
?>
<div class="row">
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs tabstop">
            ...
            <li class="<?php echo ($_GET['page'] == 'course_admin') || $_GET['page'] == 'user_record' || $_GET['page'] == 'progress_detail'
                     || $_GET['page'] == 'call_detail' || $_GET['page'] == 'course_admin_mentors' || $_GET['page'] == 'progress_detail' || $_GET['page'] == 'map_mentors' || $_GET['page'] == 'manage_mentor_calls'?'active':''; ?>"><a href="admin.php?page=course_admin">Course Admin</a></li>            
            <li class="<?php echo ($_GET['page'] == 'surveys') || $_GET['page'] == 'new_survey' || $_GET['page'] == 'manage_survey'
                     || $_GET['page'] == 'survey_result'?'active':''; ?>"><a href="admin.php?page=surveys">Surveys</a></li>                        
            <li class="lastchild <?php echo ($_GET['page'] == 'templates_email')?'active':''; ?>"><a href="admin.php?page=templates_email">Email Templates</a></li>
        </ul>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs tabstop">            
            <li class="<?php echo ($_GET['page'] == 'course_admin') || $_GET['page'] == 'user_record' || $_GET['page'] == 'progress_detail'
                     || $_GET['page'] == 'call_detail' || $_GET['page'] == 'progress_detail' || $_GET['page'] == 'manage_mentor_calls'?'active':''; ?>"><a href="admin.php?page=course_admin">Course Admin</a></li>            
