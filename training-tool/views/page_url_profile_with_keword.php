            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <div class="firstspan">Title Relevancy : </div> <div class="secondspan"><?php echo $analys->title->title_relevant == 1 ? "<img class='imgoffon' title='This is looking fine' src='$onimg' />" : "<img class='imgoffon' title='please fix this error' src='$ofimg' />"; ?> <?php echo $analys->title->title_relevancy; ?> %</div>
                            <div class="clearfix"></div>
                            <div class="notebottom alert alert-info">
                                <strong>Note: </strong> The title tag should match the content on webpage. Relevancy more than <?php echo TITLE_RELEVANCY; ?> % is good.
                            </div>
                        </li>
                ...
                <div class="panel-body">
                    ...
                    <ul class="list-group">                                 
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="secondspan"><?php echo isset($analys->links->broken_links) ? count($analys->links->broken_links) : 0; ?>
                                ...
                                <div><a href="javascript:;" onclick="jQuery('.modalbrokenlinks').modal();" class="brokenlinks">Click to see broken links</a> </div>
                            </div>
                            </div>
                            <div class="col2div">
                            <div class="notebottom alert alert-info">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="col1div">
                            <div class="firstspan">Links Without Title Attribute : </div> <div class="secondspan"><?php echo count($analys->links->no_title); ?>                                
                                &nbsp;&nbsp;<?php echo count($analys->links->no_title) <= 0 ? "<img class='imgoffon' title='This is looking fine' src='$onimg' />" : "<img class='imgoffon' title='please fix this error' src='$ofimg' />"; ?>                                
                                <div><a href="javascript:;" onclick="jQuery('.modaltitlelinks').modal();" class="titlelinks">Click to see links without title attribute</a> </div>                                
                            </div>
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="col2div">
                            <div class="firstspan">Links Without Rel Attribute : </div> <div class="secondspan"><?php echo count($analys->links->no_rel); ?>
                                &nbsp;&nbsp;<?php echo count($analys->links->no_rel) <= 0 ? "<img class='imgoffon' title='This is looking fine' src='$onimg' />" : "<img class='imgoffon' title='please fix this error' src='$ofimg' />"; ?>
                                <div><a href="javascript:;" onclick="jQuery('.modalrellinks').modal();" class="rellinks">Click to see links without rel attribute</a> </div>
                            </div>
                            </div>
                            <div class="col2div">
                            <div class="notebottom alert alert-info">
                                <strong>Note: </strong> The no-follow attribute helps with SEO position because it tells search engines not to conflict multiple links coming from the same site with organic linking.
                            </div>
                            </div>
                        </li>
                    </ul>
...
<?php include_once 'links_modal.php'; ?>
