...
$helplinks = $wpdb->get_results
        ...
        $wpdb->prepare
                (
                "SELECT * FROM " . media()." WHERE lesson_id = %d AND type = 'link'", $lesson_id
        )
);
...
$notes = $wpdb->get_results
        ...
        $wpdb->prepare
                (
                "SELECT * FROM " . lesson_notes()." WHERE lesson_id = %d", $lesson_id
        )
);
...
<div class="contaninerinner">       
    ...
    <a href="admin.php?page=module_detail&module_id=<?php echo $module_id; ?>" class="btn btn-danger pull-right"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Back</a>
    </h4>
