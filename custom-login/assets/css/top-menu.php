    ...
    <div class="container-fluid" style="padding-left:0; padding-right:0;">
        ...
        <div class="hor-menu hor-menu-full">
            <ul class="nav navbar-nav navbar-nav-full">
                ...
                <?php if ($menu_control[$update_level_name]['company_profile'] != 'No') { ?>
                    <li class="menu-dropdown classic-menu-dropdown nav-drop-arrow">
                        ...
                        <ul class="dropdown-menu pull-left">
                            <?php
                            if (!actual_writer($CURENT_ID, $USRID)) {
                                if ($menu_control[$update_level_name]['account_info'] != 'No') {
                                    ?>
                                    <li>
                            ...
                            if ($menu_control[$update_level_name]['list_profile'] != 'No') {
                                ?>
<!--                                <li><a href="<php echo site_url(); ?>/api-mapping/?api=hubspot"  class="nav-link">List Profile</a></li>-->
                            <?php }
                                
                                if ($menu_control[$update_level_name]['site-keywords'] != 'No') { ?>
                                <li><a href="<?php echo site_url(); ?>/site-keywords/"  class="nav-link">Keywords</a></li>
                            <?php }  ?>
                        </ul>
                    </li>
                <?php } ?>
                    ...
                    <li class="menu-dropdown classic-menu-dropdown  nav-drop-arrow">
                        ...
                        <ul class="dropdown-menu pull-left">
                            ...
                            <?php } if ($menu_control[$update_level_name]['traffic-reports'] != 'No') { ?>
                                <li><a href="<?php echo str_replace("https", "http", site_url()); ?>/traffic-reports/" class="nav-link">Traffic Report</a></li>
                    ...
                    <li class="menu-dropdown classic-menu-dropdown  nav-drop-arrow">
                        ...
                        <ul class="dropdown-menu pull-left">
                            <?php if ($menu_control[$update_level_name]['re_keyword'] != 'No') { ?>
                                <li><a href="<?php echo site_url(); ?>/keyword-opportunities/" class="nav-link">Keywords</a></li>
        ...
        if(isset($trial_package) && !empty($trial_package)){
            ...
            if($trial_activetill >= $currentdate){
                ...
                <div class="alert alert-danger" style="float: left;margin-top: 10px;padding: 3px 0;text-align: center;width: 100%;">
                    TRIAL ACCOUNT <strong ><?php echo floor($days_left);?> DAYS LEFT.</strong><a class="btn btn-primary" style="border-radius: 3px !important;margin: 0 0 0 17px;padding: 4px 7px !important;" href="<?php echo $billing_page;?>">Subscribe</a>
                </div>
                <?php 
